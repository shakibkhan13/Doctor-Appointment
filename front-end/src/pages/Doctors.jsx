  ...
  return (
    <div className="px-4 py-6 bg-gray-100 min-h-screen">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">Select a speciality to find your preferred doctor.</p>
      </div>

      {/* Specialities Section */}
      <div className="grid grid-cols-1 md:grid-cols-6 gap-6 mb-10">
        {['General Physician', 'Gynecologist', 'Dermatologist', 'Pediatricians', 'Neurologist', 'Gastroenterologist'].map((specialty, index) => (
          <p
            key={index}
            className={`cursor-pointer text-center text-white py-2 px-4 rounded-lg ${
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {filterDoc.length > 0 ? (
          filterDoc.map((item) => (
            ...
            >
              {/* Image Container */}
              <div className="w-full h-40 bg-blue-50 overflow-hidden flex justify-center items-center">
                <img
              ...
              <div className="p-4">
                ...
                <h2 className="text-gray-900 text-lg font-semibold">{item.name}</h2>
